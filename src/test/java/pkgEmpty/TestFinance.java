...
public class TestFinance {
	...
	public void TestPV() {
		...
		//	In my calculations, in order to receive a payment of $7358 ($10000-2642), if you were
		//  making 2% on your return, and you wanted it paid off
		//	over a 20 year period... You'd need to save $1,454,485.55.
		
		//	Accounting rules- PV returns a negative number if you pass in a positive PMT amount.  
		// Take the absolute value
		
		//	I want to copmare a double with a double... Doubles are not precice... I have to give a 
		//  rounding factor.
	...
	public void TestPMT() {
		...
		double r = Retirement.PMT(d2,480.0,0.0,PV,false);
		
		assertEquals(554.13, Math.abs(r), 0.01);
